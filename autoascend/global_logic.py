    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: leaving the first floor at XL5 once healed avoids lethal over-farming and reaches richer, appropriately scaled progression sooner.
                condition = lambda: self.agent.blstats.experience_level >= 5 and \
