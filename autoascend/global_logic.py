    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: waiting longer to reach higher experience before descending gives stronger combat and survivability
            ...
            elif self.milestone == Milestone.GO_DOWN:
                # hypothesis: after reaching level 1 and gaining enough XP, descend directly to deeper floors
                # This should speed progression and avoid dangerous early-level farming.
                condition = lambda: True
                level = (Level.DUNGEONS_OF_DOOM, 2)
